...
import 'ongoing_trip_point_service.dart';
...
class TripPostProcessorService extends RiverpodService {
  ...
  OngoingTripPointService get _tripPointService => ref.read(ongoingTripPointServiceProvider);
  OngoingTripPointDA get _tripPointDA => ref.read(ongoingTripPointDAProvider);
  ...
  Future<bool> concludeTrip() async {
    OngoingTripPointService tripPointService = _tripPointService;
    OngoingTripPointDA tripPointDA = _tripPointDA;
    ...
    List<OngoingTripPoint> tripPoints = await tripPointDA.selectAll();
    ...
    for (OngoingTripPoint tripPoint in tripPoints) {
